...
Revision ID: 7e1cd3f60a86
Revises: 
Create Date: 2025-04-21 14:05:06.414491
...
def upgrade() -> None:
    ...
    sa.Column('id_subasta', sa.String(), nullable=False),
    ...
    sa.Column('id_contrato', sa.String(), nullable=False),
    ...
    sa.Column('id_subasta', sa.String(), nullable=True),
    ...
    sa.Column('id_documentacion', sa.String(), nullable=False),
    ...
    sa.Column('id_registro_visita', sa.String(), nullable=False),
    ...
    sa.Column('id_orden_compra', sa.String(), nullable=False),
    ...
    sa.Column('id_contrato', sa.String(), nullable=True),
    sa.Column('id_cliente', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['id_cliente'], ['clientes.id_cliente'], ),
    ...
    sa.Column('id_actas_custodias', sa.String(), nullable=False),
    ...
    sa.Column('id_orden_compra', sa.String(), nullable=True),
    ...
    sa.Column('id_entrega', sa.String(), nullable=False),
    ...
    sa.Column('id_vale_consumo', sa.String(), nullable=False),
    ...
    sa.Column('id_factura', sa.String(), nullable=False),
    ...
    sa.Column('id_entrega', sa.String(), nullable=True),
    ...
    sa.Column('id_guia_remision', sa.String(), nullable=False),
    ...
    sa.Column('id_logistica_transport', sa.String(), nullable=False),
    ...
    sa.Column('id_seguimiento_pago', sa.String(), nullable=False),
    ...
    sa.Column('id_factura', sa.String(), nullable=True),
    sa.Column('id_registro_visita', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['id_factura'], ['facturas.id_factura'], ),
