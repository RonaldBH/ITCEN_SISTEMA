...
def get_seguimiento(db: Session, seguimiento_id: str):
...
def update_seguimiento(db: Session, seguimiento_id: str, seguimiento: SeguimientoPagosUpdate):
...
def delete_seguimiento(db: Session, seguimiento_id: str):
    db_seguimiento = get_seguimiento(db, seguimiento_id)
    if not db_seguimiento:
        return None
